    ...
    <div className={`${styles.boxWidth} ${styles.paddingY}`}>
      <div className='flex items-start gap-10'>
        <div className='flex-[3]'>
          <img src={blog2} alt="blog image 1" />
          <div className='flex items-center py-5 gap-3'>
            <span className='font-medium text-[0.9rem] text-gray-500'>Fashion --- </span>
            <span className='text-[0.8rem] text-gray-500'>April 25, 2022</span>
          </div>
          <h1 className='pb-5 text-[2.2rem] font-medium'>New Finds From Tuckernuck</h1>
            ...
            <Link to='/clothing'>
              <div className='flex items-start gap-8 cursor-pointer'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <p className='text-[0.9rem] font-medium max-w-[200px]'> Sets From Saks</p>
                </div>
              </div>
            </Link>
